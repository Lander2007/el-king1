...
async function seed() {
    try {
        ...
        // 1. Seed Categories
        const appleCat = await Category_1.Category.create({
        ...
        const samsungCat = await Category_1.Category.create({
        ...
        const accessoriesCat = await Category_1.Category.create({
        ...
        const settings = await Settings_1.Settings.create({
        ...
        await Product_1.Product.insertMany(productsToSeed);
